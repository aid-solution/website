...
const PowerPointBanner = () => {
  return (
    <div className=" relative h-[calc((100vh-158px)/1.5)] mt-[-38px]">
      <div></div>
      <Image
        src={"/banner/formation-powerpoint.png"}
        alt="PowerPoint Background"
        fill
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full">
        <h1 className="uppercase text-5xl text-white font-bold text-center">Faites sensation avec <span>Outlook</span></h1>
      </div>
    </div>
...
export default PowerPointBanner