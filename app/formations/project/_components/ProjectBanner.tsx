...
const ProjectBanner = () => {
  return (
    <div className=" relative h-[calc((100vh-158px)/1.5)] mt-[-38px]">
      <div></div>
      <Image
        src={"/banner/formation-project.png"}
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full">
        <h1 className="uppercase text-5xl text-white font-bold text-center">Menez vos projets à bon port avec <span>MS Project</span></h1>
      </div>
    </div>
