  ...
  return (
    <div className="px-2 lg:px-[100px] py-[50px]">
      <div className="relative mb-10">
        <h1 className="uppercase text-3xl md:text-4xl font-extrabold text-center pb-4">Nos marques commercialisées</h1>
